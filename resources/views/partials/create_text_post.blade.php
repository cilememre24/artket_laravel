    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-8">
            <form id="regForm" action="{{ route('create_post', ['type' => 'text'])}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="all-steps" id="all-steps"> <span class="step"><i class="fa fa-header"></i></span> <span class="step"><i class="fa fa-align-justify"></i></span> <span class="step"><i class="fa fa-picture-o"></i></span> <span class="step"><i class="fa fa-keyboard-o"></i></span></div>
                <div class="tab">
